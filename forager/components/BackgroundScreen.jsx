...
const BackgroundScreen = () => {
  ...
  return (
    ...
    >
      ...
      <div 
        className="absolute top-0 left-1/2 transform -translate-x-1/2 w-[420px] h-[132px] flex-shrink-0 rounded-b-lg shadow-lg flex justify-between items-center px-4"
      ...
      <div 
        className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-[420px] h-[119px] flex-shrink-0 rounded-t-lg shadow-lg flex justify-between items-center px-4"
        style={{ background: "rgba(0, 0, 0, 0.50)" }}
      >
